 ...
 */
@WebServlet(name = "ParkingLotRetrievalServlet", urlPatterns = {"/ParkingLotRetrievalServlet"})
   ...
   LinkedList<ParkingLot> parkingLots;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ParkingLotRetrievalServlet.class.getName()).log(Level.SEVERE, null, ex);
        }

        RequestDispatcher requestDispatcher
                = request.getRequestDispatcher("show_all_parking.jsp");

        request.setAttribute("paarkingLots", parkingLots);
